// Class
// - 현실과 비슷한 개념(객체)을 나타내기 위한 도구를 클래스(Class)라고 한다.
...
// JavaScript에서 사용할 수 있는 모든 값은 프로퍼티 값으로 사용할 수 있는데, 프로퍼티 값이 함수일 경우에는 일반 함수와 구분하기 위해 메서드(Method)라고 부른다.
