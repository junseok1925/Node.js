...
//  객체란?
// JavaScript의 데이터 타비은 크게 원시타입과 객체 타입으로 분류된다
// 	원시타입은 단하나의 값만을 나타내고, 원시 타입의 값은 변경이 불가능 한 값이다.
//  객체 타입은 다양한 타입의 값을 하나의 단위로 구성한 복합적인 자료 구조이고, 객체 타입의 값을 변경 가능한 값이다.

// JavaScript는 객체(Object)기반의 프로그래밍 언어, 구성하는 거의 모든 것은 객체로 구성,객체(Object) 는 0개 이상의 프로퍼티로 구성된 집합이며, 하나의 프로퍼티는 Key와 Value로 구성
